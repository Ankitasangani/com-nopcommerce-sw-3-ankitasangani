...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("FirstName"), "Ankita");   //Enter first name
        sendTextToElement(By.id("LastName"), "Sangi");     //Enter last name
        ...
        sendTextToElement(By.id("Password"), "Ankita@1995");     //Enter password
        sendTextToElement(By.id("ConfirmPassword"), "Ankita@1995");  //Confirm password
