...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.10 Check Two Check boxes "Microsoft Office [+$50.00]" and "Total Command
        Thread.sleep(1000);
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Ankita");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Sangi");
        sendTextToElement(By.id("BillingNewAddress_Email"), "ankitasangi123@gmail.com");
        selectByValueFromDropDown(By.id("BillingNewAddress_CountryId"), "133");
        sendTextToElement(By.id("BillingNewAddress_City"), "Delhi");
        sendTextToElement(By.id("BillingNewAddress_Address1"), "A 47");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "110006");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "07424365789");
        //Click on “CONTINUE”
